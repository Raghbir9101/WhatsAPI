...
class IndiaMartScheduler {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.setupAllUserSchedules();
            // Check for new configs every 5 minutes
            this.configCheckInterval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                yield this.setupAllUserSchedules();
            }), 5 * 60 * 1000);
    ...
    setupAllUserSchedules() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const configs = yield models_1.IndiaMartConfig.find({
                    isActive: true,
                ...
                for (const config of configs) {
                    ...
                    // Setup new schedule
                    yield this.setupUserSchedule(config);
                }
            }
            catch (error) {
    ...
    setupUserSchedule(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                yield this.fetchLeadsForUser(config.userId);
            }), intervalMs);
    ...
    fetchLeadsForUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            const startTime = new Date();
            let logEntry = null;
            const config = yield models_1.IndiaMartConfig.findOne({ userId, isActive: true });
            try {
                ...
                // Create log entry
                logEntry = yield models_1.IndiaMartLog.create({
                    userId: userId,
                ...
                if (response.data && Array.isArray(response.data)) {
                    for (const lead of response.data) {
                        try {
                            ...
                            const existingLead = yield models_1.IndiaMartLead.findOne({
                            ...
                            // Create new lead
                            yield models_1.IndiaMartLead.create({
                                userId: userId,
                                uniqueQueryId: lead.UNIQUE_QUERY_ID,
                ...
                yield models_1.IndiaMartConfig.findOneAndUpdate({ userId: userId }, {
                    lastFetchTime: now,
                ...
                // Update log entry
                yield models_1.IndiaMartLog.findByIdAndUpdate(logEntry._id, {
                    status: 'success',
                    endTime: endTimeLog,
                ...
                yield models_1.IndiaMartConfig.findOneAndUpdate({ userId: userId }, {
                    ...
                    totalApiCalls: yield models_1.IndiaMartConfig.findOne({ userId: userId }).then(c => c ? c.totalApiCalls + 1 : 1)
                });
                // Update log entry
                if (logEntry) {
                    yield models_1.IndiaMartLog.findByIdAndUpdate(logEntry._id, {
                        ...
                        duration: endTimeLog.getTime() - startTime.getTime(),
                        error: error.message,
                        errorCode: ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.toString()) || 'UNKNOWN',
                        apiResponse: {
                            statusCode: ((_c = error.response) === null || _c === void 0 ? void 0 : _c.status) || 0,
                            message: error.message,
                            data: ((_d = error.response) === null || _d === void 0 ? void 0 : _d.data) || null
                        }
                    });
                }
                // Handle retries if enabled
                if ((_e = config === null || config === void 0 ? void 0 : config.settings) === null || _e === void 0 ? void 0 : _e.retryFailedCalls) {
                    const retryCount = (logEntry === null || logEntry === void 0 ? void 0 : logEntry.retryCount) || 0;
                    ...
                    if (retryCount < maxRetries) {
                        ...
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield this.fetchLeadsForUser(userId);
...
exports.default = indiaMartScheduler;
